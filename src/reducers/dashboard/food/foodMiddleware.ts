...
import { FoodApiResponse, FoodOFFResponse } from '../../../Interfaces/API_Interfaces';
    ...
    try {
      ...
      if (results.length === 0) {
        return rejectWithValue({
          severity: 'error',
          message:
            "Nous n'avons pas réussi à récupérer les catégories provenant de https://fr.openfoodfacts.org/",
        });
      }
